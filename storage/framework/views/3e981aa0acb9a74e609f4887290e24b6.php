    ...
    <div class="createacompetition">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success">
                ...
                <p><strong>ФИО судьи:</strong> <?php echo e(session('name')); ?></p>
                <p><strong>Логин:</strong> <?php echo e(session('login')); ?></p>
                <p><strong>Пароль:</strong> <?php echo e(session('password')); ?></p>
            </div>
        <?php endif; ?>

        <form action="<?php echo e(route('judges.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\OSPanel\domains\eventserver3\resources\views/judges/create.blade.php ENDPATH**/ ?>