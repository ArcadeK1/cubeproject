        ...
        <form action="<?php echo e(route('competitions.store')); ?>" method="POST">
            ...
            <div class="challenges_to_add">
                ...
                <div class="challenges-container">
                    <a href="<?php echo e(route('challenges.create')); ?>" class="newchallengebtn">+ Новое испытание</a>
                    <?php $__currentLoopData = $challenges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="challenge-item">
                            <input type="checkbox" id="challenge_<?php echo e($challenge->id); ?>" name="challenges[]" value="<?php echo e($challenge->id); ?>">
            ...
            <div class="teams_to_add">
                ...
                <div class="teams-container">
                    <a href="<?php echo e(route('teams.create')); ?>" class="newteambtn">+ Новая команда</a>
                    <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="team-item">
                            <input type="checkbox" id="team_<?php echo e($team->id); ?>" name="teams[]" value="<?php echo e($team->id); ?>">
                ...
                <div class="judges-container">
                    ...
                    <?php $__currentLoopData = $judges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $judge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="judge-item">
                            <input type="checkbox" id="judge_<?php echo e($judge->id); ?>" name="judges[]" value="<?php echo e($judge->id); ?>">
...
</html><?php /**PATH C:\OSPanel\domains\eventserver3\resources\views/competitions/create.blade.php ENDPATH**/ ?>